...
(2, 'Number Recognition', 'A web application that recognizes handwritten digits using a machine learning model.', 'https://github.com/Ahmet-Toplu/Number_Recognition', '/images/NumberRecognition');
